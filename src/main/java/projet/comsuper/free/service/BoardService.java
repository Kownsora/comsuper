...
import projet.comsuper.free.entity.BoardFileEntity;
import projet.comsuper.free.repository.BoardFileRepository;
...
//            String savePath = "/Users/사용자이름/springboot_img/" + storedFileName; // C:/springboot_img/9802398403948_내사진.jpg
    ...
    public Page<BoardDTO> paging(Pageable pageable) {
        ...
        Page<BoardDTO> boardDTOS = boardEntities.map(board -> new BoardDTO(board.getId(), board.getBoardWriterId(), board.getBoardWriter(), board.getBoardTitle(), board.getCreatedTime()));
        return boardDTOS;
    }
}
